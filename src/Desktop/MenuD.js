    ...
    <div style={containerStyle} className="custom-container">
      <div className="row">
        ...
        <div className="d-flex justify-content-center" style={bar}>
          <button onClick={() => setSelectedCategory('entree')} className={`mx-2 ${selectedCategory === 'entree' ? 'btn btn-primary' : 'btn btn-outline-primary'}`}>Entree</button>
          <button onClick={() => setSelectedCategory('main')} className={`mx-2 ${selectedCategory === 'main' ? 'btn btn-primary' : 'btn btn-outline-primary'}`}>Main</button>
          <button onClick={() => setSelectedCategory('extras')} className={`mx-2 ${selectedCategory === 'extras' ? 'btn btn-primary' : 'btn btn-outline-primary'}`}>Extras</button>
          <button onClick={() => setSelectedCategory('drinks')} className={`mx-2 ${selectedCategory === 'drinks' ? 'btn btn-primary' : 'btn btn-outline-primary'}`}>Drinks</button>
          <button onClick={() => setSelectedCategory('alcohol')} className={`mx-2 ${selectedCategory === 'alcohol' ? 'btn btn-primary' : 'btn btn-outline-primary'}`}>Alcohol</button>
        </div>
          ...
          {Array.isArray(menuData[selectedCategory]) ? (
            menuData[selectedCategory].map((item, index) => (
              <div className="d-flex flex-column" key={index} >
                ...
                <div>
                  <p style={itemStyle}>{item.description}</p>
                </div>
              </div>
            ))
          ) : (
